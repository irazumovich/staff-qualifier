    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.goals.update", [$goal->id]) }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('name') ? 'is-invalid' : '' }}" type="text" name="name" id="name" value="{{ old('name', $goal->name) }}" required>
                @if($errors->has('name'))
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('description') ? 'is-invalid' : '' }}" type="text" name="description" id="description" value="{{ old('description', $goal->description) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('confirmation_method') ? 'is-invalid' : '' }}" type="text" name="confirmation_method" id="confirmation_method" value="{{ old('confirmation_method', $goal->confirmation_method) }}">
